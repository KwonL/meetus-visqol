...
def run_test():
    ...
    delay = get_delay_for_inout(os.getenv("WAVE_INPUT_FILENAME"), WAVE_OUTPUT_FILENAME)

    save_result_to_db("MEETUS", score, delay)

    return jsonify([{"name": "MOS", "score": score}, {"name": "DELAY", "score": delay}])
